...
2. [Razão e Proporção](#Razao-e-Proporcao)
3. [Regra de Três Simples](#Regra-de-Tres-Simples)
4. [Regra de Três Composta](#Regra-de-Tres-Composta)
...
> Exemplo Prático 01: se nós aumentarmos a quantidade de aviões (<i class="icofont-long-arrow-up"></i>) iremos aumentar, também, a quantidade de passageiros (<i class="icofont-long-arrow-up"></i>). Neste caso as grandezas são **diretamente proporcionais**.

> Exemplo Prático 02: quanto mais rápido for o carro, ou seja, quanto maior for a velocidade (<i class="icofont-long-arrow-up"></i>) em menos tempo Mariana irá chegar na casa de seus avós (<i class="icofont-long-arrow-down"></i>). Neste caso as grandezas são **inversamente proporcionais**.
...
| nº de Aviões <i class="icofont-long-arrow-up"></i> | nº de Passageiros <i class="icofont-long-arrow-up"></i>|
|--------------|:-----------------:|
| 1 | 215 |
| x | 786 |
...
| Velocidade <i class="icofont-long-arrow-up"></i> | Tempo <i class="icofont-long-arrow-down"></i>|
|--------------|:-----------------:|
| 100 | 5 |
| 150 | x |
...
Para efetuar os cálculos devemos, primeiramente, inverter uma das duas colunas. Repare agora que as duas setas (<i class="icofont-long-arrow-up"></i>) estão apontando para a mesma direção:

| Velocidade <i class="icofont-long-arrow-up"></i> | Tempo <i class="icofont-long-arrow-up"></i>|
|--------------|:-----------------:|
| 100 | x |
| 150 | 5 |
...
> Exemplo Prático 03: Se aumentarmos a quantidade de impressoras (<i class="icofont-long-arrow-up"></i>) poderemos aumentar a quantidade de livros (<i class="icofont-long-arrow-up"></i>) e de funcionários (<i class="icofont-long-arrow-up"></i>).

> Exemplo Prático 04: Quanto mais confeiteiros tiver na padaria (<i class="icofont-long-arrow-up"></i>) mais bolos de aniversário eles irão fazer (<i class="icofont-long-arrow-up"></i>) em menos tempo (<i class="icofont-long-arrow-down"></i>).
...
| nº de Impressoras <i class="icofont-long-arrow-up"></i> | nº de Funcionários <i class="icofont-long-arrow-up"></i> | nº de Livros <i class="icofont-long-arrow-up"></i> |
|-------------------|:------------------:|--------------|
| 5 | 15 | 300 |
| 10 | 10 | x |
...
| nº de Confeiteiros <i class="icofont-long-arrow-up"></i> | nº de Dias <i class="icofont-long-arrow-down"></i> | nº de Bolos <i class="icofont-long-arrow-up"></i> |
|-------------------|:------------------:|--------------|
| 4 | 6 | 72 |
| x | 3 | 96 |
...
| nº de Confeiteiros <i class="icofont-long-arrow-up"></i> | nº de Dias <i class="icofont-long-arrow-up"></i> | nº de Bolos <i class="icofont-long-arrow-up"></i> |
|-------------------|:------------------:|--------------|
| 4 | 3 | 72 |
| x | 6 | 96 |
...
01. Represente as frações abaixo na forma de números decimais:
a) $\frac{1}{5}$
b) $\frac{2}{10}$
c) $\frac{1}{10}$
d) $\frac{11}{22}$
...
02. Em cada situação abaixo, informe se as grandezas são inversamente ou diretamente proporcionais.
...
e) Gustavo e seu ajudante conseguem consertar 6 automóveis por dia. Se ele contratar mais 2 ajudantes, conseguirá consertar 24 automóveis em 2 dias.

03. João percorreu de bicicleta 150 km em 3 dias, pedalando 2 horas, diariamente. Pedalando 4 horas por dia, durante  5 dias, ele percorrerá quantos quilômetros?

04. O investimento de 10.000,00 na melhoria da logística de uma empresa gera uma economia de 2.000,00.
a) Para termos uma economia de 3.500,00 quanto devemos investir?
b) Quanto tempo levaríamos para recuperar um investimento de 15.000,00 feito nas mesmas condições.

05. Para descarregar 15 vagões de trem em uma hora e meia precisamos de 5 funcionários. Quantos funcionários serão necessários para descarregar 120 vagões em 6  Horas?

06. O preço de custo de uma mercadoria é de R$ 450,00. Para que se tenha um lucro de 20% na venda dessa mercadoria, por quanto deve-se vende-la?

07. Numa promoção o preço de um objeto foi reduzido de R$ 920,50 para R$ 845,75. De quantos por cento foi redução?

08. Victor recebeu um aumento de 15% e com isso seu salário chegou a R$1.322,50. Calcule o salário inicial de Victor.

09. Em certo trimestre, as cadernetas de poupança renderam 2,5% de correção monetária. Paulo deixou R$ 2.318,00 depositados durante três meses. Quanto Paulo resgatou?

10. João comprou uma TV à prazo, pois não podia pagar à vista. Sabendo que o valor à vista é de R$ 1500,00 e que o valor total à prazo é 12,5% maior que o valor à vista, responda: Quanto João vai pagar no total?
